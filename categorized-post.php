...
?>
    <body>
       ...
       $sql="select tblposts.id as postid,tblposts.PostImage,tblposts.PostTitle,tblposts.StartingPara,tblposts.quote,tblposts.EndingPara,tblposts.PostingDate,tblcategory.CategoryName as category,tblcategory.id as catid from tblposts left join tblcategory on tblcategory.id=tblposts.CategoryId  where tblposts.CategoryId = '$id' and tblposts.Is_Active=1  order by tblposts.id DESC ";
       $query=mysqli_query($con,$sql);
       $total_col = mysqli_num_rows($query);
       if($total_col==0){
          header('location:blog.php');
       }else{
