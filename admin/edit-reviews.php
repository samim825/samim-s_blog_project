...
$query=mysqli_query($con,"Update tblreviews set name='$name',designation='$designation',comment='$comment' where id = '$id' ");
...
<?php 
$id=intval($_GET['id']);
$query=mysqli_query($con,"Select *from  tblreviews where id='$id'");
$cnt=1;
