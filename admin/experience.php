...
if (strlen($_SESSION['login']) == 0) {
    ...
    if ($_GET['action'] == 'del' && $_GET['rid']) {
        $id = intval($_GET['rid']);
        $query = mysqli_query($con, "delete from  tblexperience  where id='$id'");
    ...
    if (isset($_POST['submit'])) {
        ...
        $query = mysqli_query($con, "insert into tblexperience(date,designation,companyName,details) values('$date','$designation','$companyName','$details')");
        if ($query) {
                                            ...
                                            <div class="col-md-11">
                                                <form name="education" method="post" class="form-horizontal" enctype="multipart/form-data">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-10">
                                                            <input type="text" class="form-control" placeholder="Enter Instituion Name" name="designation" required>
                                                        </div>
                                                    </div>
                                                    <div class="form-group">                                                       
    ...
    while ($row = mysqli_fetch_array($query)) {
        ?>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td><a href="edit-experience.php?id=<?php echo htmlentities($row['id']); ?>"><i class="fa fa-pencil" style="color: #29b6f6;"></i></a> 
                                                                &nbsp;<a href="experience.php?rid=<?php echo htmlentities($row['id']); ?>&&action=del"> <i class="fa fa-trash-o" style="color: #f05050"></i></a> </td>
                                                        </tr>
        <?php
        $cnt++;
    }
