...
$query=mysqli_query($con,"Update tbleducation set date='$date',instituteName='$instituteName',certificateName='$certificateName',details='$details' where id = '$id' ");
...
<?php 
$id=intval($_GET['id']);
$query=mysqli_query($con,"Select *from  tbleducation where id='$id'");
$cnt=1;
                                            ...
                                            <div class="col-md-11">
                                                <form name="education" method="post" class="form-horizontal" enctype="multipart/form-data">
                                                    ...
                                                    <div class="form-group">
                                                        <h4 class="col-md-2 header-title control-label"><b>Institute Name</b></h4>
                                                        <div class="col-md-10">
                                                            <input type="text" class="form-control" value="<?php echo htmlentities($row['instituteName']);?>" name="instituteName" required>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="form-group">                                                       
                                                        ...
                                                        <div class="col-md-10">
                                                            <input type="text" class="form-control" value="<?php echo htmlentities($row['certificateName']);?>" name="certificateName" required>
                                                        </div>
                                                    </div>
                                                    <div class="form-group">                                                       
